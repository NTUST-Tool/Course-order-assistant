...
2. 點擊右上角「+」
3. 輸入程式顯示的 topic（例如：`B11XXX345_a3f9`）
...
**A:** 不會！
- 🔐 topic 使用 MD5 加密（學號_MD5後4位）
- 🔐 只有知道完整學號才能生成正確 topic
- 🔐 別人無法通過 topic 反推學號
- 🔐 資料僅存在本地檔案，不上傳伺服器 -->
